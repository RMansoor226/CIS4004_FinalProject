...
function App() {
    ...
    return (
        <div id={"appPage"}>
            ...
            {currentPage === "dashboard" && <Dashboard course={testCourse} user={currentUser} />}
            {currentPage === "courses" && <Courses course={testCourse} user={currentUser} />}
            {currentPage === "intro" && (
                <QuizInstructions
                    quiz={testQuiz}
